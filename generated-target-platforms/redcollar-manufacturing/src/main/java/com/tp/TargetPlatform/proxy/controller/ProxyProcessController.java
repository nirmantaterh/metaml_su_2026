...
// REST controller starting proxy instances and registering their businessKey with PairRegistry.
@RestController
...
public class ProxyProcessController {
    ...
    public ProxyProcessController(RuntimeService runtimeService, PairRegistry pairRegistry, RunExecutionGate executionGate) {
