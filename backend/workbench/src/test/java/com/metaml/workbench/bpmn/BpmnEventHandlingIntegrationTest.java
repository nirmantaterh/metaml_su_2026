...
// Verifies Event SubProcess, Timer Boundary Event, and Error Boundary Event execution in Camunda.
class BpmnEventHandlingIntegrationTest {
    ...
    void setUp() {
        ...
        config.setJdbcUrl("jdbc:h2:mem:bpmn-event-" + java.util.UUID.randomUUID() + ";DB_CLOSE_DELAY=-1");
