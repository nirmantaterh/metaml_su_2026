...
//
// Brought to parity with templates/camundademo's own CapabilityConfig for P7 Final Acceptance
// Closure: this file previously predated P7 Step 5 and never gained the binding-cache wiring, so no
// RedCollar-generated Target Platform could ever retrieve a Workbench-authoritative binding - the
// dispatcher fell straight to "no binding, fail closed" for every capability-required activity,
// regardless of what was ever bound in the Workbench. Nothing here is RedCollar-specific.
@Configuration
